...
#SBATCH -J distillm-base-ablate-kdratio
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
KD_RATIOS=(0.9 0.7 0.5 0.3)
KD_RATIO=${KD_RATIOS[$SLURM_ARRAY_TASK_ID]}
echo "Using KD_RATIO=${KD_RATIO}"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2-base/train/distill_0.1B_1.5B_kdratio=${KD_RATIO}"
# seed
SEED=10
...
export WANDB_NAME="dolly/gpt2/distillm-train_0.1B_1.5B_kdratio=${KD_RATIO}"
