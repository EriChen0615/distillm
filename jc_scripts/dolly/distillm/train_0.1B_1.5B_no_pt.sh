...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2-base/train/distill_0.1B_1.5B_no-pt"
# seed
SEED=10
...
export WANDB_NAME="dolly/gpt2/distillm-train_0.1B_1.5B_no-pt"
