...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2-base/train/seqkd/base_xlarge_from_init_241218"
# seed
SEED=10
...
export WANDB_NAME="dolly/gpt2/seqkd_from_init-train_0.1B_1.5B"
