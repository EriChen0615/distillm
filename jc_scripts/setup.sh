...
# huggingface-cli download openai-community/gpt2-xl --local-dir checkpoints/gpt2-xlarge
...
# huggingface-cli download databricks/databricks-dolly-15k --repo-type dataset --local-dir data/dolly
