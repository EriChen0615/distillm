...
CKPT="${BASE_PATH}/../../hf_models/${CKPT_NAME}"
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5-0.5B-Instruct/gsm8k/train/kd"
# seed
SEED=10
...
export WANDB_NAME="gsm8k_qwen2.5-0.5B/kd-lr-${LR}-bs-${BATCH_SIZE}-grad-${GRAD_ACC}-eval-bs-${EVAL_BATCH_SIZE}-max-length-${MAX_LENGTH}-max-prompt-length-${MAX_PROMPT_LENGTH}-seed-${SEED}-ep-${EPOCHS}"
