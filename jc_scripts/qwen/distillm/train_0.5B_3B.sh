...
TEACHER_PEFT_PATH="${BASE_PATH}/results/qwen2.5-3B-Instruct/gsm8k/train/sft/e10-bs4-lr5e-06-G16-N1-NN1-lora-8-32-0.1/1120"
# data
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen2.5-0.5B-Instruct/gsm8k/train/distillm"
# seed
SEED=10
...
export WANDB_NAME="gsm8k_qwen2.5-0.5B/distillm_from_init_teacher=LoRASFT-10ep_-lr-${LR}-bs-${BATCH_SIZE}-grad-${GRAD_ACC}-eval-bs-${EVAL_BATCH_SIZE}-max-length-${MAX_LENGTH}-max-prompt-length-${MAX_PROMPT_LENGTH}-seed-${SEED}-ep-${EPOCHS}"
